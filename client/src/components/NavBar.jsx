...
import buttonVoyageTotoro from "../assets/images/buttonVoyageTotoro.jpg";
import buttonGhibliothèque from "../assets/images/buttonGhibliothèque.jpg";

function NavBar({ hideTitle }) {
  const logoRef = useRef();
  const EarthRef = useRef();
  const BookRef = useRef();

  // Fonction pour démarrer l'animation au survol
  ...
  // Fonction pour arrêter l'animation lorsque la souris quitte le logo
    ...
    <div className="nav-bar">
      <Link to="/Accueil">
        <img
          ...
          ref={logoRef}
          src={logo}
          onMouseEnter={handleMouseEnter} // Démarrer l'animation au survol
          onMouseLeave={handleMouseLeave}
          alt="Logo Totoro" // Arrêter l'animation au départ de la souris
        />
      </Link>
      <h1 className={`univers-blibli ${hideTitle ? "hidden" : ""}`}>
        L'univers de Blibli
      </h1>
      <div className="animation">
        ...
        <Link to="/VoyageTotoro">
          <button className="button-voyage" type="button">
            Voyage de Totoro
          </button>
          <img
            className="button-icone"
            ref={EarthRef}
            src={buttonVoyageTotoro}
            onMouseEnter={handleMouseEnter1} // Démarrer l'animation au survol
            onMouseLeave={handleMouseLeave1}
            alt="Icone Voyage Totoro" // Arrêter l'animation au départ de la souris
          />
        </Link>
        <Link to="/Ghibliotheque">
          <button className="button-ghibliotheque" type="button">
            Ghibliothèque
          </button>
          <img
            className="button-icone"
            ref={BookRef}
            src={buttonGhibliothèque}
            onMouseEnter={handleMouseEnter2} // Démarrer l'animation au survol
            onMouseLeave={handleMouseLeave2}
            alt="Icone Ghibliothèque" // Arrêter l'animation au départ de la souris
          />
        </Link>
      </div>
    </div>
